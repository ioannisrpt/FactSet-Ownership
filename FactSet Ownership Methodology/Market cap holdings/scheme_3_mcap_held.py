...
print('13F Holder + non 13F Securities - SCHEME 3 (MCAP HELD) \n')
...
#   SAVE
# ~~~~~~~~~~~
scheme_3_final.write_parquet(os.path.join(cd, 'scheme_3_mcap_held.parquet'))
